...
#if LV_USE_WAYLAND
    #define LV_WAYLAND_BUF_COUNT            2    /**< Use 1 for single buffer with partial render mode or 2 for double buffer with full render mode*/
    #define LV_WAYLAND_USE_DMABUF           1    /**< Use DMA buffers for frame buffers. Requires LV_DRAW_USE_G2D */
    #define LV_WAYLAND_RENDER_MODE          LV_DISPLAY_RENDER_MODE_DIRECT   /**< DMABUF supports LV_DISPLAY_RENDER_MODE_FULL and LV_DISPLAY_RENDER_MODE_DIRECT*/
